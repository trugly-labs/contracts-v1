...
// contract Trugly404Memeception is ITruglyMemeception, Owned {
//     using FixedPointMathLib for uint256;
//     using SafeCastLib for uint256;
//     using SafeTransferLib for WETH;
//     using SafeTransferLib for MEME404;
...
//         MEME404 memeToken =
//             new MEME404{salt: params.salt}(params.name, params.symbol, params.creator, params.ranks, params.uris);
