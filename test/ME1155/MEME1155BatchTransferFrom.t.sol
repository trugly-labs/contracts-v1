...
contract MEME1155BatchTransferFromTest is DeployersME404 {
    ...
    /// Expect Tier 3 Burn: []
    /// Expect Tier 4 Burn: []
    function test_1155safeBatchTransferFromScenario30_success() public {
    ...
    /// Expect Tier 3 Burn: []
    /// Expect Tier 4 Burn: []
    function test_1155safeBatchTransferFromScenario31_success() public {
        ...
        tier2NFT.safeBatchTransferFrom(SENDER, RECEIVER, _tokenIds(2), amounts, "");
