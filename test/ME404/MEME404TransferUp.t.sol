...
contract MEME404Test is DeployersMEME404 {
    ...
    function test_transferUpFirstTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[0].amountThreshold);
    }

    function test_transferUpSecondTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[1].amountThreshold);
    }

    function test_transferUpThirdTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[2].amountThreshold);
    }

    function test_transferUpFourthTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[3].amountThreshold);
    }

    function test_transferUpFifthTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[4].amountThreshold);
    }

    function test_transferUpSecondHighestTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[params.length - 2].amountThreshold);
    }

    function test_transferUpHighestTier() public {
        me404BaseTest.transfer(BOB, ALICE, params[params.length - 1].amountThreshold);
    }
