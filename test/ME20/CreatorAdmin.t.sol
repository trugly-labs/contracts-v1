...
contract CreatorAdminTest is DeployersME20 {
    ...
    function setUp() public override {
        ...
        assertEq(memeToken.creator(), address(memeceptionBaseTest), "creator post setup");
    ...
    function test_already_initialized() public {
        ...
        memeToken.initializeFirst(address(1), 1, 1, routers, routers);

        hoax(memeceptionBaseTest.MULTISIG());
        vm.expectRevert(AlreadyInitialized.selector);
        memeToken.initializeLast(address(1), address(2));
    }
    ...
    function test_post_memeception() public {
        ...
        assertEq(memeToken.isExempt(address(memeceptionBaseTest)), true, "post setup isExempt creator");
